...
class SharedNetwork(nn.Module):
    ...
    def __init__(self, config_master, config_model, is_critic=False):
        ...
        self.human_num = config_master.config_HA.sim.human_num
        ...
        # for past velocities
        input_dim_to_fused_embedding += config_model.lookback * 2
